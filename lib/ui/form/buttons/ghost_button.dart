...
class GhostButton extends FlatButton with BaseButtonThemer {
  GhostButton({
    Key key,
    ...
    Color disabledTextColor = MainColors.cielo,
          ...
          child: child is Widget
              ...
              : new Text(
                  ...
                  style: onPressed == null
                      ? defaultButtonGhostTextDisabled
                      : defaultButtonGhostText,
                ),
        ) {
